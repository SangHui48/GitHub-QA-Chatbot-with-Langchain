...
df = pd.DataFrame(
    {
        "GitHub": [
            "https://github.com/holly-21",
            "https://github.com/aza1200",
            "https://github.com/furthermares",
            "https://github.com/SangHui48",
        ]
    },
...
with tab1:
    ...
    st.markdown("\n")
    st.write(
        "**_깃-털을 통해 GitHub의 다양한 데이터를 분석하고 요약하여, 개발자들은 더 효율적인 개발과 협업을 이룰 수 있습니다._**"
    )
